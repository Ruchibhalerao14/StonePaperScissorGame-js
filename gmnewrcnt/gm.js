...
const pickCompHand=(choice)=>{
    ...
    if(cpHand == "paper"){
        document.getElementById("comppickedimg").src ="paper.png"
        choosed.style.borderColor = "#FFA943";
    }
    else if (cpHand == "stone") {
        document.getElementById("comppickedimg").src ="hand.png"
        choosed.style.borderColor = "#0074B6";
    }
    
    else{
        document.getElementById("comppickedimg").src ="scissor.png"
        choosed.style.borderColor = "#BD00FF";
    }
